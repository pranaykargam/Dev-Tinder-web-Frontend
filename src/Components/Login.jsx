          ...
          <div className="space-y-4">
            {!isLoginForm && (
              <>
                ...
                <fieldset className="border-2 border-black p-3 rounded-xl font-serif shadow-md transition-colors duration-300">
                  <legend className="text-sm text-white font-medium">
                    Last Name
                  </legend>
                  <input
                    type="text"
            ...
            <fieldset
              className="border-2 border-black p-3 rounded-xl font-serif shadow-md
...
// export default Loginexport default Loginexport default Loginexport default Loginexport default Loginexport default Login
